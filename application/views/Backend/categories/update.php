	      ...
	      <div class="row">
	        ...
	        <div class="col-md-6">
	          ...
	          <div class="box box-info">
	            ...
	            @endif -->
	            <form class="form-horizontal" action="<?php echo base_url();?>backend/categories_updated" method="post">
	                <!-- @csrf -->
	              <div class="box-body">
	                <div class="form-group">
	                  <label for="" class="col-sm-2 control-label">Categories</label>
	                  <input type="hidden" class="form-control" name="id" value="<?php echo $categories->category_id;?>">
	                  <div class="col-sm-10">
