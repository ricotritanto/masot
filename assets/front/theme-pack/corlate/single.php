    ...
    <?php get_template_part('lib/sub-header'); ?>
        <div class="container single-wrapper-content">
            <div class="row">
                ...
                <?php }elseif ($sidebarstyle == 'left' && get_theme_mod('sidebar_single', true)) { 
                    get_sidebar(); ?>
                    <div id="content" class="site-content col-md-<?php echo $col; ?> blog-content-wrapper sidebar-wrap" role="main">
                        <?php if ( have_posts() ) :  ?> 
                            <?php while ( have_posts() ) : the_post(); ?>
                                <?php get_template_part( 'post-format/content', get_post_format() ); ?>   
                            <?php endwhile; ?>    
